...
CREATE DOMAIN bin20 AS bytea CONSTRAINT exactly_20_bytes_long CHECK ( octet_length(VALUE) = 20 );
CREATE DOMAIN bin16 AS bytea CONSTRAINT exactly_16_bytes_long CHECK ( octet_length(VALUE) = 16 );
CREATE DOMAIN bin4 AS bytea CONSTRAINT exactly_4_bytes_long CHECK ( octet_length(VALUE) = 4 );

CREATE DOMAIN uint8 AS int8 CONSTRAINT positive CHECK ( 0 <= VALUE );
CREATE DOMAIN uint4 AS int8 CONSTRAINT between_0_and_4294967295 CHECK ( VALUE BETWEEN 0 AND 4294967295 );
CREATE DOMAIN uint2 AS int4 CONSTRAINT between_0_and_65535 CHECK ( VALUE BETWEEN 0 AND 65535 );
CREATE DOMAIN uint1 AS int2 CONSTRAINT between_0_and_255 CHECK ( VALUE BETWEEN 0 AND 255 );
